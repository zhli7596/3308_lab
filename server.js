...
app.get('/player_info/post', function(req, res) {
	...
	var query3 = 'select count(*) from football_players '+'inner join football_games on football_players.id = any(football_games.players) where football_players.id = '+id+';';
